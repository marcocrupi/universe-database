...
INSERT INTO public.galaxy VALUES (3, 'Triangulum', 'Spiral', 3000, false);
INSERT INTO public.galaxy VALUES (4, 'Whirlpool', 'Spiral', 6000, true);
INSERT INTO public.galaxy VALUES (5, 'Large Magellanic Cloud', 'Irregular', 8000, true);
INSERT INTO public.galaxy VALUES (6, 'Small Magellanic Cloud', 'Irregular', 9000, false);
...
ALTER TABLE ONLY public.satellite
    ADD CONSTRAINT satellite_orbiting_planet_id_fkey FOREIGN KEY (orbiting_planet_id) REFERENCES public.planet(planet_id);
